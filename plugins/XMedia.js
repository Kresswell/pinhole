...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'px4mp4', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (!message.reply_message.video) return await message.sendMessage('●▬▬ *𝙆𝙍𝙀𝙎𝙎𝙒𝙀𝙇𝙇𝘽𝙊𝙏* ▬▬● *Need Video!*');
        var downloading = await message.client.sendMessage(message.jid,'●▬▬ *𝙆𝙍𝙀𝙎𝙎𝙒𝙀𝙇𝙇𝘽𝙊𝙏* ▬▬● ```Editing..```',MessageType.text)
    ...
    Asena.addCommand({pattern: 'px2mp4', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (!message.reply_message.video) return await message.sendMessage('●▬▬ *𝙆𝙍𝙀𝙎𝙎𝙒𝙀𝙇𝙇 𝘽𝙊𝙏* ▬▬● *Need Video!*');
        var downloading = await message.client.sendMessage(message.jid,'●▬▬ *𝙆𝙍𝙀𝙎𝙎𝙒𝙀𝙇𝙇 𝘽𝙊𝙏* ▬▬● ```Editing..```',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
                id: message.reply_message.id
